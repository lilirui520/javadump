...
type Config struct {
	...
	//minio
	MinioApiHost   string `ini:"minio.apiHost"`
	MinioAccessKey string `ini:"minio.accessKey"`
	MinioSecretKey string `ini:"minio.secretKey"`
	MinioBucket    string `ini:"minio.bucket"`

	//通知相关
	NotifyDingToken string `ini:"notify.dingtalkToken"`
	NotifyWxToken   string `ini:"notify.wxKey"`
	DingTokenSign   string `ini:"notify.sign"`
